...
class RestaurantServiceTest {
    ...
    public void searching_for_non_existing_restaurant_should_throw_exception() throws restaurantNotFoundException {
        ...
        restaurantNotFound = Assertions.<restaurantNotFoundException>assertThrows(restaurantNotFoundException.class, () -> service.findRestaurantByName(restaurantName), "Restaurant Not Found");
